#!/usr/bin/env python3
"""Refresh the managed documentation bundle for a project."""
...
from doc_orchestrator_lib import docs_root_path, load_snapshot, parse_targets, write_docs


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Patch the managed documentation set for a project."
    )
