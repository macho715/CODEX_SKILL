...
- When coordinator artifacts exist, compare the implementation against the
  chosen recommendation and the verifier remaining gaps.
- Treat drift from the selected option or ignored verifier blockers as
  `SURFACE` findings.
