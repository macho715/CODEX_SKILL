...
## Coordinator-driven QA

- Convert verifier remaining gaps into mandatory QA checks.
- If a scoring assumption influenced the selected option, include at least one
  regression case that validates that assumption in code or runtime behavior.
