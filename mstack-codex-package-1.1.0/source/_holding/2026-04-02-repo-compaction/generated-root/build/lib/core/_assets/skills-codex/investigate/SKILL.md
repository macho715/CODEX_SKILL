...
- Use `pipeline-coordinator` only after evidence has narrowed the problem and
  multiple fix strategies remain.
- Do not replace root-cause investigation with coordinator speculation.
