...
If the workflow is moving in the opposite direction, from `excel-professional-formatting` back into `excel-vba`, read [handoff-operational-checklist.md](handoff-operational-checklist.md) first.
