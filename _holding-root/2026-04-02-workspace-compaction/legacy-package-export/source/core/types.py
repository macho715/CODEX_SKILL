...
class PipelineRequestClassifierInput:
    ...
    executor_capabilities: frozenset[RouterDecision] = field(
        default_factory=lambda: frozenset({RouterDecision.SINGLE})
    )
...
class PipelineRequestClassifierResult:
    ...
    required_execution_mode: RouterDecision | None = None
