...
flowchart LR
    root["smoke-doc-app"]
    inspect["Inspect real files"]
    snapshot_node["Normalize snapshot"]
    docs["Managed docs set"]
    root --> inspect --> snapshot_node --> docs
    README_md["README"]
    docs --> README_md
    PLAN_md["PLAN"]
    docs --> PLAN_md
...
## Refresh Metadata
- Generated at: `2026-03-30T03:53:40+00:00`
- Project root: `C:\Users\SAMSUNG\Downloads\skill\tmp-doc-orchestrator-smoke-20260329100642`
